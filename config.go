...
import (
	...
	"github.com/palcoin-project/palcwallet/internal/cfgutil"
	"github.com/palcoin-project/palcwallet/internal/legacy/keystore"
	"github.com/palcoin-project/palcwallet/netparams"
	"github.com/palcoin-project/palcwallet/wallet"
)

const (
	defaultCAFilename       = "palcd.cert"
	defaultConfigFilename   = "palcwallet.conf"
	defaultLogLevel         = "info"
	defaultLogDirname       = "logs"
	defaultLogFilename      = "palcwallet.log"
	defaultRPCMaxClients    = 10
	defaultRPCMaxWebsockets = 25
)

var (
	btcdDefaultCAFile  = filepath.Join(palcutil.AppDataDir("palcd", false), "rpc.cert")
	defaultAppDataDir  = palcutil.AppDataDir("palcwallet", false)
...
type config struct {
	...
	// RPC client options
	RPCConnect       string                  `short:"c" long:"rpcconnect" description:"Hostname/IP and port of btcd RPC server to connect to (default localhost:1967, testnet: localhost:1967, simnet: localhost:11918)"`
	CAFile           *cfgutil.ExplicitString `long:"cafile" description:"File containing root certificates to authenticate a TLS connections with palcd"`
	...
	LegacyRPCListeners     []string                `long:"rpclisten" description:"Listen for legacy RPC connections on this interface/port (default port: 1987, testnet: 1987, simnet: 11916)"`
