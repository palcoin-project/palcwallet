...
type RescanJob struct {
	...
	OutPoints   map[wire.OutPoint]palcutil.Address
...
// rescan.
func (w *Wallet) Rescan(addrs []palcutil.Address, unspent []wtxmgr.Credit) error {
...
func (w *Wallet) rescanWithTarget(addrs []palcutil.Address,
	unspent []wtxmgr.Credit, startStamp *waddrmgr.BlockStamp) error {

	outpoints := make(map[wire.OutPoint]palcutil.Address, len(unspent))
