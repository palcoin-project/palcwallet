...
func (m *mockChainClient) Rescan(*chainhash.Hash, []palcutil.Address,
	map[wire.OutPoint]palcutil.Address) error {
	return nil
}

func (m *mockChainClient) NotifyReceived([]palcutil.Address) error {
	return nil
}
