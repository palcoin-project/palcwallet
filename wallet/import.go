...
func (w *Wallet) ImportPublicKey(pubKey *btcec.PublicKey,
	...
	err = w.chainClient.NotifyReceived([]palcutil.Address{addr.Address()})
	if err != nil {
...
func (w *Wallet) ImportPrivateKey(scope waddrmgr.KeyScope, wif *palcutil.WIF,
	...
	if rescan {
		...
		err := w.chainClient.NotifyReceived([]palcutil.Address{addr})
		if err != nil {
