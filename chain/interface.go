...
type Interface interface {
	...
	Rescan(*chainhash.Hash, []palcutil.Address, map[wire.OutPoint]palcutil.Address) error
	NotifyReceived([]palcutil.Address) error
	NotifyBlocks() error
...
type (
	...
	FilterBlocksRequest struct {
		...
		ExternalAddrs    map[waddrmgr.ScopedIndex]palcutil.Address
		InternalAddrs    map[waddrmgr.ScopedIndex]palcutil.Address
	...
	FilterBlocksResponse struct {
		...
		FoundOutPoints     map[wire.OutPoint]palcutil.Address
