...
func TestBlockFiltererOneInOneOut(t *testing.T) {
	...
	watchedOutPoints[firstTx.TxIn[0].PreviousOutPoint] = &palcutil.AddressWitnessPubKeyHash{}
	watchedOutPoints[lastTx.TxIn[0].PreviousOutPoint] = &palcutil.AddressWitnessPubKeyHash{}
