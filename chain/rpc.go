...
func (c *RPCClient) Rescan(startHash *chainhash.Hash, addrs []palcutil.Address,
...
func (c *RPCClient) onRecvTx(tx *palcutil.Tx, block *btcjson.BlockDetails) {
...
func (c *RPCClient) onRedeemingTx(tx *palcutil.Tx, block *btcjson.BlockDetails) {
